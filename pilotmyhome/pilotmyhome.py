...
def product_card(product: dict):
    return rx.link(
        ...
        border="1px solid #EAEAEA", border_radius="10px",
        padding="1em", width="280px",
...
def guides() -> rx.Component:
    return base_layout(
        rx.vstack(
            ...
            #         href="/guides/stewardship"),
            # rx.link("Tech for Connection: Our Picks for Family Movie Nights",
            #         href="/guides/connection"),
